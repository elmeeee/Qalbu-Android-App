...
@javax.inject.Qualifier @Retention(AnnotationRetention.BINARY) annotation class ReflectJson
...
@javax.inject.Qualifier @Retention(AnnotationRetention.BINARY) annotation class SearchApi
