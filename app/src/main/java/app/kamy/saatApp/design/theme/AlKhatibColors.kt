...
object AlKhatibColors {
    ...
    val EmeraldRich = Color(0xFF065F46)
    val EmeraldNight = Color(0xFF022C22)
    val ForestDark = Color(0xFF0B3D34)
    val ForestDeeper = Color(0xFF051F1A)
    val ReaderMoss = Color(0xFF0A3D2E)
    val ReaderForest = Color(0xFF0F2A22)
