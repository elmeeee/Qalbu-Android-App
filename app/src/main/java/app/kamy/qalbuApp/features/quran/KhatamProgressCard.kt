...
import app.kamy.qalbuApp.infrastructure.preferences.KhatamUiSnapshot
    ...
    Column(
        ...
        KhatamProgressLine(
            ...
            detail = stringResource(
                ...
                (snapshot.overallProgressFraction * app.kamy.qalbuApp.infrastructure.preferences.MushafReadingStore.totalPages).toInt(),
                app.kamy.qalbuApp.infrastructure.preferences.MushafReadingStore.totalPages
            )
        )
    }
}
