...
import app.kamy.qalbuApp.infrastructure.preferences.RamadanPreferencesStore
...
fun QiyamTrackerRow(
    ...
    var loggedTonight by remember {
        mutableStateOf(app.kamy.qalbuApp.infrastructure.preferences.QiyamTrackerStore.isLogged(context))
    }
    val snapshot = remember(loggedTonight) {
        app.kamy.qalbuApp.infrastructure.preferences.QiyamTrackerStore.snapshot(context)
    }
    ...
    Row(
        modifier = modifier
            .fillMaxWidth()
            .clickable {
                loggedTonight = app.kamy.qalbuApp.infrastructure.preferences.QiyamTrackerStore.toggleTonight(context)
            }
